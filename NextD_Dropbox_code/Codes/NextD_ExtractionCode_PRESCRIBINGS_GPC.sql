...
from (select c.PATID,a.ENCOUNTERID,b.PRESCRIBINGID,b.RXNORM_CUI,
		...
		year(b.RX_ORDER_DATE) as PX_ORDER_DATE_YEAR,month(b.RX_ORDER_DATE) as PX_ORDER_DATE_MONTH,datediff(d,c.FirstVisit,b.RX_ORDER_DATE) as DAYS_from_FirstEncounter_Date,b.RX_PROVIDERID,b.RX_DAYS_SUPPLY,b.RX_REFILLS ,b.RX_BASIS
