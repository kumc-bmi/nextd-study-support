...
3. CAP_ENCOUNTERS table from CAPRICORN.
...
---------------------------------------------------------------------------------------------------------------
select d.GLOBALID,i.ENCOUNTERID,i.PRESCRIBINGID,i.RXNORM_CUI,i.RX_ORDER_DATE,i.RX_PROVIDERID,i.RX_DAYS_SUPPLY,i.RX_REFILLS ,i.RX_BASIS, /*insert site label here:*/ 'SomeLabele' as SITELABEL
into #NextD_PRESCRIBING_FINAL
from #NextD_PRESCRIBING i join  /* provide name the table containing c.PATID,Hashes, and Global patient id*/ #GlobalIDtable d on i.PATID=d.CAP_ID;
---------------------------------------------------------------------------------------------------------------
