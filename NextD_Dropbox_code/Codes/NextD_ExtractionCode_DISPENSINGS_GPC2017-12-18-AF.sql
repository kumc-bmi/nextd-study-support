...
---------------------------------------------------------------------------------------------------------------
select i.PATID,i.DISPENSINGID,i.NDC,i.DISPENSE_DATE_YEAR,i.DISPENSE_DATE_MONTH,i.DAYS_from_FirstEncounter_Date,i.DISPENSE_SUP,i.DISPENSE_AMT,i.RAW_NDC 
...
year(b.DISPENSE_DATE) as DISPENSE_DATE_YEAR,month(b.DISPENSE_DATE) as DISPENSE_DATE_MONTH,datediff(d,c.FirstVisit,b.DISPENSE_DATE) as DAYS_from_FirstEncounter_Date,b.DISPENSE_SUP,b.DISPENSE_AMT,b.RAW_NDC
