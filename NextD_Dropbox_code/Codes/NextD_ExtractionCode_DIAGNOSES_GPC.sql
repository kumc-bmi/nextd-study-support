...
---------------------------------------------------------------------------------------------------------------
select i.PATID,i.ENCOUNTERID,i.DIAGNOSISID,i.DX,i.PDX,i.DX_TYPE,i.DX_SOURCE,i.DX_ORIGIN ,i.ENC_TYPE,i.ADMIT_DATE_YEAR,i.ADMIT_DATE_MONTH,i.DAYS_from_FirstEncounter_Date 
...
from (select c.PATID,b.ENCOUNTERID,b.DIAGNOSISID,b.DX,b.PDX,b.DX_TYPE,b.DX_SOURCE,b.DX_ORIGIN ,b.ENC_TYPE,
		...
		year(b.ADMIT_DATE) as ADMIT_DATE_YEAR,month(b.ADMIT_DATE) as ADMIT_DATE_MONTH,datediff(d,c.FirstVisit,b.ADMIT_DATE) as DAYS_from_FirstEncounter_Date
