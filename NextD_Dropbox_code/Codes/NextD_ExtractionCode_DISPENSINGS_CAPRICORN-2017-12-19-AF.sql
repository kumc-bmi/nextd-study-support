...
---------------------------------------------------------------------------------------------------------------
select i.PATID,i.DISPENSINGID,i.NDC,i.DISPENSE_DATE,i.DISPENSE_SUP,i.DISPENSE_AMT,i.RAW_NDC 
...
b.DISPENSE_DATE,b.DISPENSE_SUP,b.DISPENSE_AMT,b.RAW_NDC
...
---------------------------------------------------------------------------------------------------------------
select d.GLOBALID,i.DISPENSINGID,i.NDC,i.DISPENSE_DATE,i.DISPENSE_SUP,i.DISPENSE_AMT,/*insert site label here:*/ 'SomeLabele' as SITELABEL
