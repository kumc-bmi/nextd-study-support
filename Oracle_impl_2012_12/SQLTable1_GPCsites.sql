...
(
   ...
   (
     ...
     or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Amaryl M%')
     or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Avandamet%')
     or (
            UPPER(a.RAW_RX_MED_NAME) like UPPER('%Metformin%')
         -- Exclude metformin in combination with specific diabetes drugs found in specific meds query
         and not (  UPPER(a.RAW_RX_MED_NAME) like UPPER('%Kazano%')
                 or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Invokamet%')
                 or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Xigduo XR%')
                 or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Synjardy%')
                 or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Metaglip%')
     ...
     or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Actoplus%')
     or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Actoplus Met%')
     or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Actoplus Met XR%')
     or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Competact%')
     --this one is combination of metformin-repaglinide:
     or UPPER(a.RAW_RX_MED_NAME) like UPPER('%PrandiMet%')
     --this is combination of metformin-saxagliptin :
     or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Kombiglyze XR%')
...
OR
   ...
   (
     ...
     or (
         ...
         -- Exclude in combination
         and not (
                    --this one is combination of metformin-rosiglitazone:
                    UPPER(a.RAW_RX_MED_NAME) like UPPER('%Avandamet%')
                    --this is combination of rosiglitizone-metformin:
                 or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Amaryl M%')
                    --this is combination of glimeperide-rosiglitazone :
                 or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Avandaryl%')
     ...
     or (
            UPPER(a.RAW_RX_MED_NAME) like UPPER('%pioglitazone%')
         -- Exclude in combination
         and not (
                    --this ione is combination of metformin-pioglitazone :
                    UPPER(a.RAW_RX_MED_NAME) like UPPER('%Actoplus%')
                 or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Actoplus Met%')
                 or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Actoplus Met XR%')
                 or UPPER(a.RAW_RX_MED_NAME) like UPPER('%Competact%')
                    --this is combination of glimepiride-pioglitazone:
     ...
     or regexp_like(UPPER(a.RAW_RX_MED_NAME), UPPER('Re[zs]ulin'))
